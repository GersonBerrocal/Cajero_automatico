...
public class App {
	public static void main(String[] args) {
		...
		usuarios.add(new Usuario(98765, "123", 506.3f, "Gerson"));
		usuarios.add(new Usuario(12345, "123", 1200.0f, "Rosa"));
		...
		while (true) {
			...
			int intentos = 1;
			do {
				mostrar_panel = (intentos <= 3 && intentos > 1)
	...
	public static boolean ejecutar_opciones(int op, Usuario user, Scanner sc, ArrayList<Usuario> usuarios) {
		...
		case 5:
			...
			par = new String[] { "Operacion", "Pago de servicio", "Servicio", nombre_servicio, "Monto", deuda_aletoria + "",
					"Saldo", user.getSaldo() + "", };
			vaucher(user, par);
			return true;
		case 6:
